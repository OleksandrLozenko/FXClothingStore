...
public class LoginController implements Initializable {
    ...
    @FXML private void clickButtonEnter(){
        try {
            ...
            if(user.getPassword().equals(pe.getEncryptPassword(pfPassword.getText().trim(),pe.getSalt()))){
                jptv22clothingstore.JPTV22СlothingStore.currentUser = user;
    ...
    public void autorizationAction() {
        tfLogin.setText(jptv22clothingstore.JPTV22СlothingStore.currentUser.getLogin());
    ...
    private  boolean autorization() {
        if(jptv22clothingstore.JPTV22СlothingStore.currentUser.getPassword().equals(pfPassword.getText())){
            return true;
        }else{
            return false;
        }
